...
exports.trackCodeEvent = exports.trackEvent = exports.trackPageview = void 0;
...
var initAnalytics = function initAnalytics(userId, url, ctaSelector) {
  ...
  return function (data) {
    return (0, analytics_api_1.trackCodeEvent)({
      ts: Date.now(),
      url: url,
      userId: userId,
      data: data
...
var initABTest = function initABTest(params, log) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var hideOtherVariants, testEl, testName, showVariant, testVariants, expirationDate, variantFromLS, test, LStestVariant, numberOfVariants, randomVariant, randomName;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          hideOtherVariants = function hideOtherVariants(variants) {
            return function (name) {
              ...
              if (variantIndex < 0) {
                log === null || log === void 0 ? void 0 : log('AB test, can not find saved variant');
          ...
          testEl = document.querySelector("[".concat(const_1.AB.SELECTOR_NAME, "]"));
          if (testEl) {
            _context3.next = 7;
            break;
          }
        ...
        case 7:
          testName = testEl.getAttribute(const_1.AB.SELECTOR_NAME);
          showVariant = function showVariant(name) {
            return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    log === null || log === void 0 ? void 0 : log("AB test, name: ".concat(testName, ", variant: ").concat(name));
          ...
          testVariants = testEl.querySelectorAll("[".concat(const_1.AB.SELECTOR_VARIANT, "]"));
        ...
        case 15:
          ...
          return _context3.abrupt("return");
        case 20:
          expirationDate = testEl.getAttribute(const_1.AB.SELECTOR_EXPIRATION);
          if (expirationDate) {
            _context3.next = 26;
            break;
          }
        ...
        case 34:
          ...
          // check LS
          variantFromLS = function variantFromLS(test) {
          ...
          LStestVariant = variantFromLS(test);
          if (!LStestVariant) {
            _context3.next = 40;
            break;
          }
        ...
        case 40:
          ...
          numberOfVariants = testVariants.length;
          randomVariant = Math.floor(Math.random() * numberOfVariants);
          randomName = Array.from(testVariants)[randomVariant].getAttribute(const_1.AB.SELECTOR_VARIANT);
          if (randomName) {
            _context3.next = 47;
            break;
          }
...
},{"./const":"src/ab-test/const.ts","./local-storage":"src/ab-test/local-storage.ts","../const":"src/const.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var logger = (0, analytics_1.initAnalytics)(const_1.userId, url, const_1.CTA_SELECTOR);
...
// Log errors servise
},{"./styles.css":"src/styles.css","./const":"src/const.ts","./analytics/analytics":"src/analytics/analytics.ts","./ab-test":"src/ab-test/index.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
